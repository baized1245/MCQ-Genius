...
const Reviews = () => {
  return (
    <div className="bg-[#FFFFFF] max-w-7xl mx-auto px-4 py-14 relative">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="text-center montserrat p-8 flex flex-col gap-5 montserrat">
          <h2 className="text-[#000000] font-bold text-5xl ">
            Our Students Reviews
          </h2>
          <h3 className="text-[#000000] font-bold text-3xl">
            কেন আমরাই শিক্ষার্থীর প্রথম পছন্দ?
          </h3>
        </div>

        {/* container */}
        <div className="grid grid-cols-3 gap-5 poppins px-8">
      ...
      <div className="flex gap-x-[1130px] absolute bottom-40">
        <Image
          src={leftArrow}
          alt="Blog Page Image"
